...
public class Tutorial extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerView = v.findViewById(R.id.rvTutorial);
    ...
    public void readContent(){
        ...
        client.get("https://759b74ce43947f5f4c91aeddc3e5bad3d.codepolitan.com/api/v2/posts/category/tutorial", new AsyncHttpResponseHandler(){

            @Override
            public void onStart() {
                Log.d("TutorialFragment", "onStart: proses pembacaan API dimulai");
            }

            @Override
            public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
                Log.d("TutorialFragment", "onSuccess: pembacaan data API berhasil");
            ...
            public void onFailure(int statusCode, Header[] headers, byte[] responseBody, Throwable error) {
                Log.d("TutorialFragment", "onFailure: pembacaan data gagal dengan kode " + statusCode);
            }

            @Override
            public void onRetry(int retryNo) {
                Log.d("TutorialFragment", "onRetry: melakukan pembacaan ulang API");
            }
        });
    }
